...
words = ['monday', 'mouse', 'computer', 'desktop', 'smarthphone', 'dangerous', 'creativity']
correct_letters = []
incorrect_letters = []
tries = 6
right_answers = 0
...
def check_letter(chosen_letter, hidden_word, tries, matches):
    ...
    if chosen_letter in hidden_word and chosen_letter not in correct_letters:
        ...
        print("You have found this letter already. Choose other one")
    else:
